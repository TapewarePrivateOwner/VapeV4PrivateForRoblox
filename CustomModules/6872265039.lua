...
pcall(function()
	whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/gloxed/VapeV4PrivateForRoblox/main/whitelist2.json", true))
end)
